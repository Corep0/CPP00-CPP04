...
/*   Updated: 2025/10/03 11:02:51 by seruff           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Constructor FragTrap called for " << get_name()
	       	<< std::endl;
	set_hit_points(100);
...
void	FragTrap::highFivesGuys(void)
{
	if (get_hit_points() <= 0 || get_energy_points() <= 0)
		...
		std::cout << "High-fives requested:" << "*CLAP CLAP CLAP CLAP CLAP*" << std::endl;
}
